...
- 🔍 Focused on **Offensive & Defensive Security**
...
- 🎯 CTF Enumeration & Exploitation  
- 🛠 Tools:  
  `Nmap` `Metasploit` `Burp Suite` `Hydra` `Nikto` `Gobuster`

---

## 🔵 Blue Team Skills (Defensive Security)

- 🛡️ SOC Operations & Log Analysis  
- 📊 SIEM Monitoring (Splunk / ELK)  
- 🚨 Incident Response  
- 🔍 Threat Detection & Analysis  
- 🧰 Tools:  
  `Wireshark` `Splunk` `Elastic Stack` `OSSEC` `Wazuh`
...
- 🛡️ **Virtual Memory & Deadlock Simulator**
...
### 🧪 Labs & Practice
- ✅ TryHackMe Rooms (Linux, Web, PrivEsc)
- ✅ Hack The Box Machines
- ✅ OWASP Juice Shop
- ✅ Custom Vulnerable Lab Setup
